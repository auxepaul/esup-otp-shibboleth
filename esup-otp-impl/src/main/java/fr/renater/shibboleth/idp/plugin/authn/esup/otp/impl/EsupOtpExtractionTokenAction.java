...
public class EsupOtpExtractionTokenAction extends AbstractAuthenticationAction {
    ...
    protected void doExecute(@Nonnull final ProfileRequestContext profileRequestContext,
        ...
        if (esupOtpContext.getMethodChoice() == null) {
            log.warn("{} No method choice", getLogPrefix());
            ActionSupport.buildEvent(profileRequestContext, EventIds.INVALID_PROFILE_CTX);
            return;
        }
    ...
    /**
     * Gets the token code from the HTTP request. First get from form request (input
     * "token"), Second get from header ("X-Shibboleth-ESUPOTP")
     *
     * @param httpRequest
     ...
     */
    @Nullable
    protected String extractCode(@Nonnull final HttpServletRequest httpRequest) {
