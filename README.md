...
|:--------------------------------|:------------------------------------------------------------------------------------:|----------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| idp.esup.otp.apiHost            |                                       &check;                                        |                                                                      | Url de l'api esup-otp-api (https://esup-otp-api.univ.fr)                                                                                                                                                    |
| idp.esup.otp.apiPassword        |                                       &check;                                        |                                                                      |                                                                                                                                                                                                             |
| idp.esup.otp.usersSecret        |                                       &check;                                        |                                                                      |                                                                                                                                                                                                             |
| idp.esup.otp.manager.link       |                                       &check;                                        |                                                                      | Url de l'application esup-otp-manager (https://esup-otp-manager.univ.fr/preferences)                                                                                                                        |
