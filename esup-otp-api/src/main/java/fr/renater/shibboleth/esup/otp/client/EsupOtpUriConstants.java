...
public final class EsupOtpUriConstants {
    ...
    public final class Public {
        ...
        /**
         * GET request to retrieve user information using a unique identifier and a hash
         * for verification.
         *
         ...
         * @param hash
         *            A hash used for verification or security purposes.
         */
        public static final String GET_USER_INFOS = "/users/{uid}/{hash}";

        /**
         * POST request to send a message using a specific method and transport
         ...
         *            The unique identifier of the user.
         * @param method
         *            The method being used for sending the message.
         * @param transport
         *            The transport mechanism used for delivering the message.
         * @param hash
         *            A hash used for verification or security purposes.
         */
        ...
        /**
         * POST request to generate a WebAuthn secret for the specified user with a
         * security hash.
         *
        ...
        /**
         * POST request to verify WebAuthn login for the specified user with a security
         * hash.
         *
    ...
    public final class Protected {
         ...
         *
         * @param uid
         *            The unique identifier of the user whose information is being
         *            requested.
         */
         ...
         *            The unique identifier of the user.
         * @param transport
         *            The specific transport method being tested.
         */
         ...
         *            The unique identifier of the user.
         * @param method
         *            The method being activated.
         * @param activation_code
         *            The code required to confirm activation.
         */
         ...
         * @param new_transport
         *            The new transport method to be set.
         */
         ...
         *            The current transport method.
         * @param new_transport
         *            The new transport method being tested.
         */
         ...
         *            The unique identifier of the user.
         * @param otp
         *            The one-time password for verification.
         * @param api_password
         *            The API password for additional security.
         */
    ...
    public final class Admin {
        ...
        /**
         * DELETE request to remove the secret associated with a specific method for a
         * user.
         *
         ...
         *            The unique identifier of the user.
         * @param method
         *            The method for which the secret is being removed.
         */
