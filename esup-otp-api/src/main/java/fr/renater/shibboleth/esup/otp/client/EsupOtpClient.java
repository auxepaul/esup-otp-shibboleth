...
public interface EsupOtpClient {
     ...
     * @return EsupOtpUserInfoResponse The response object containing the OTP user
     *         information.
     ...
     *            The unique identifier of the user.
     * @param method
     *            The method used for sending the message.
     * @param transport
     *            The transport mechanism used for sending the message.
     * @return EsupOtpResponse The response object containing the result of the
     *         message send operation.
     * @throws EsupOtpClientException
     *             If an error occurs while sending the message.
     */
    EsupOtpResponse postSendMessage(String uid, String method, String transport) throws EsupOtpClientException;

    /**
     * Generates a PassCode grid challenge for the specified user.
     *
     * @param uid
     *            The unique identifier of the user.
     * @return EsupOtpWebauthnResponse The response object containing the result of
     *         the Passcode Grid generation.
     * @throws EsupOtpClientException
     *             If an error occurs during the secret generation process.
     */
    EsupOtpPasscodeGridResponse postGeneratePasscodeGridChallenge(String uid) throws EsupOtpClientException;
     ...
     *            The unique identifier of the user.
     * @return EsupOtpWebauthnResponse The response object containing the result of
     *         the WebAuthn secret generation.
     * @throws EsupOtpClientException
     *             If an error occurs during the secret generation process.
     */
     ...
     * @param uid
     *            The unique identifier of the user.
     * @return EsupOtpUserInfoResponse The response object containing the user's OTP
     *         information.
     * @throws EsupOtpClientException
     *             If an error occurs while retrieving the user's information.
     */
    EsupOtpUserInfoResponse getUserInfos(String uid) throws EsupOtpClientException;

    /**
     * Performs a transport test for a specific transport method associated with a
     * user.
     *
     * @param uid
     *            The unique identifier of the user.
     * @param transport
     *            The transport method to be tested.
     * @return EsupOtpResponse The response object containing the result of the
     *         transport test.
     * @throws EsupOtpClientException
     *             If an error occurs during the transport test.
     */
     ...
     *            The unique identifier of the user.
     * @param method
     *            The method to be activated.
     * @throws EsupOtpClientException
     *             If an error occurs during the activation process.
     */
    ...
    /**
     * Confirms the activation of a specified method using an activation code for
     * the given user.
     *
     * @param uid
     *            The unique identifier of the user.
     ...
     *            The activation code used to confirm the activation.
     * @return EsupOtpResponse The response object containing the result of the
     *         activation.
     * @throws EsupOtpClientException
     *             If an error occurs during the process.
     ...
     *            The unique identifier of the user.
     * @param transport
     *            The current transport method.
     * @param newTransport
     *            The new transport method to replace the old one.
     * @throws EsupOtpClientException
     *             If an error occurs during the process.
     */
     ...
     *            The current transport method.
     * @param newTransport
     *            The newly updated transport method being tested.
     * @return EsupOtpResponse The response object containing the result of the
     *         test.
     * @throws EsupOtpClientException
     *             If an error occurs during the process.
     ...
     *            The unique identifier of the user.
     * @param method
     *            The method for which the secret is being set.
     * @return EsupOtpResponse The response object containing the result of the
     *         secret update.
     * @throws EsupOtpClientException
     *             If an error occurs during the process.
     ...
     *            The unique identifier of the user.
     * @param otp
     *            The one-time password used for verification.
     ...
     *            The unique identifier of the user.
     * @param body
     *            The request body for post verify webauthn.
     * @return boolean Returns true if the WebAuthn verification is successful;
     *         otherwise, false.
     * @throws EsupOtpClientException
     *             If an error occurs during the WebAuthn verification process.
     */
     ...
     *            The unique identifier of the user.
     * @param transport
     *            The transport method to be deleted.
     * @return EsupOtpResponse The response object containing the result of the
     *         deletion.
     * @throws EsupOtpClientException
     *             If an error occurs during the process.
     ...
     *
     * @return EsupOtpUsersResponse The response object containing the list of OTP
     *         users.
     * @throws EsupOtpClientException
     ...
     * @param uid
     *            The unique identifier of the user.
     * @return EsupOtpResponse The response object containing the user's
     *         information.
     * @throws EsupOtpClientException
     *             If an error occurs while retrieving the user's information.
     */
     ...
     * @throws EsupOtpClientException
     *             If an error occurs while retrieving the methods.
     */
     ...
     *
     * @param method
     *            The method associated with the transport.
     * @param transport
     *            The transport to be activated.
     * @throws EsupOtpClientException
     *             If an error occurs while retrieving the methods.
     */
     ...
     *            The method associated with the transport.
     * @param transport
     *            The transport to be deactivated.
     * @throws EsupOtpClientException
     *             If an error occurs while retrieving the methods.
     */
     ...
     *            The unique identifier of the user.
     * @param method
     *            The method for which the secret is being deleted.
     * @return EsupOtpResponse The response object containing the result of the
     *         deletion.
     * @throws EsupOtpClientException
